...
// check_delay.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CcheckdelayApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CcheckdelayApp

CcheckdelayApp::CcheckdelayApp()
{
...
// Единственный объект CcheckdelayApp

CcheckdelayApp theApp;


// Инициализация CcheckdelayApp

BOOL CcheckdelayApp::InitInstance()
{
